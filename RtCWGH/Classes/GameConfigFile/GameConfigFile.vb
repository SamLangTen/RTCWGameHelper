...
Public Class GameConfigFile
    ...
    Public Sub DeleteBinding(Command As String)
        Me.ConfigBind.Remove(Me.ConfigBind.Where(Function(r) r.Command = Command))
    End Sub
    ...
    Public Sub AddBinding(Command As String, Key As String)
        Dim orgBinding = Me.ConfigBind.FirstOrDefault(Function(r) r.Command = Command)
    ...
    Public Sub DeleteSetting(Key As String)
        Me.ConfigSeta.Remove(Me.ConfigSeta.Where(Function(r) r.Key = Key))
    End Sub
    ...
    Public Sub AddSetting(Key As String, Value As String)
        Dim orgSetting = Me.ConfigSeta.FirstOrDefault(Function(r) r.Key = Key)
    ...
    Public Sub SaveConfigFile()
        Dim fileContains As String = "//generated by RTCW, modified by RTCW Game Helper"
    End Sub
